...
def find_crossovers(dates,closing_prices):
    ...
    log.info(f"Processing for-> 1. Previous Closing Price= {old_closing_price}, 2.Current Closing Price= "
...
def plot_crossovers(dates,closing_prices,crossover):
    ...
    log.debug(f"In plot_crossover 1. Decision maker= {decision_maker}, 2. Crossover Decision= {crossover[5]}")
    ...
    log.debug(f"After plotting 1. Decision maker= {decision_maker}, 2. Trade Entry Price= {trade_entry_price},"
...
def check_stop_loss(date_index,closing_price):
    ...
    if closing_price < stop_loss_level:
        ...
        log.info(f"Stop Loss Level Crossed. Had to make a decision on below dataset."
